...
const jsonLd = {
  ...
  hasOccupation: {
    ...
    description:
      "Freelance virtual assistant providing video editing, social media management, and administrative support to global clients.",
  },
  offers: {
    "@type": "Offer",
    name: "Freelance Virtual Assistant Services",
    description:
      "Video editing, photo editing, social media marketing, podcast management, and general VA services.",
